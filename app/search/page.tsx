            ...
            >
              ...
              <div className="flex flex-1 space-x-5 justify-between">
                <div>
                  <Link
                    href={item.link}
                    className="font-bold text-black-500 hover:text-black-600 hover:underline"
                  >
                    {item.title}
                  </Link>
                ...
                <div className="flex flex-col justify-between">
                  <div className="flex items-start justify-end space-x-2 text-right">
                    ...
                    <p className="flex items-center justify-center font-bold text-sm w-10 h-10 text-white bg-gray-900 rounded-lg flex-shrink-0">
                      {item.rating || "N/A"}
                    </p>
                  </div>
